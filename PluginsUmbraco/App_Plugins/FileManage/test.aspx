<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test.aspx.cs" Inherits="PluginsUmbraco.App_Plugins.FileManage.test" %>

<%@ Register Src="~/App_Plugins/FileManage/FileManage.ascx" TagPrefix="uc1" TagName="FileManage" %>
